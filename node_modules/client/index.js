    ...
    switch (this.ship.type) {
        ...
        case 'destroyer-ship':
            ...
            if (this.input.secondAbility && this.secondCooldown < 0) {
                ...
                setTimeout(() => {this.ship.maxspeed = tmpS; this.ship.acceleration = tmpA;}, 1000);
        ...
        case "frigate-ship":
            ...
            if (this.input.firstAbility && this.firstCooldown < 0) {
                ...
                setTimeout(() => this.ship.shieldActive = false, 3000);
            ...
            if (this.input.secondAbility && this.secondCooldown < 0) {
                ...
                setTimeout(() => this.ship.projectileType = tmp, 3000);
