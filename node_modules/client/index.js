...
Client.prototype.ProcessAbilities = function (input) {
    var tmpS = this.ship.maxspeed;
    var tmpA = this.ship.acceleration;
    this.firstCooldown--;
    this.secondCooldown--;
    switch (this.ship.type) {
        ...
        case 'destroyer-ship':
            ...
            if (this.input.secondAbility && this.secondCooldown < 0) {
                ...
                setTimeout(() => {this.ship.maxspeed = tmpS; this.ship.acceleration = tmpA;}, 1000 * this.realtimeScaleCoefficient);
        ...
        case 'interceptor-ship':
            ...
            if (this.input.secondAbility && this.secondCooldown < 0) {
                ...
                setTimeout(() => {
                    this.ship.maxspeed = tmpS;
                    this.ship.acceleration = tmpA;
                    this.ship.overdrive = false;
                }, 3000 * this.realtimeScaleCoefficient);
        ...
        case "frigate-ship":
            ...
            if (this.input.firstAbility && this.firstCooldown < 0) {
                ...
                setTimeout(() => this.ship.shieldActive = false, 3000 * this.realtimeScaleCoefficient);
                this.firstCooldown = 500;
            }
            //laser guidance
            if (this.input.secondAbility && this.secondCooldown < 0) {
                var tmp = this.ship.projectileType;
                this.ship.projectileType = 'guided-small-rocket-projectile';
                setTimeout(() => this.ship.projectileType = tmp, 3000 * this.realtimeScaleCoefficient);
