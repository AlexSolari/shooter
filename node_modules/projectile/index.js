...
Projectile.prototype.CalculateDirections = function (ships) {
    ...
    if (this.autotargetDelay >= 0)
    {
        this.autotargetDelay--;
        if (this.autotargetDelay == 0)
...
ProjectileFactory.prototype.DetectStats = function (projectile, timeScale) {
...
ProjectileFactory.prototype.CreateProjectile = function (x,y, angle, emitter, type, spread, timeScale) {
