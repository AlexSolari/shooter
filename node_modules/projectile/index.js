...
Projectile.prototype.Extras = function (clients) {
        ...
        case 'singularity-projectile':
            ...
            for (var i = 0; i < enemies.length; i++) {
                ...
                if (dist.magnitude < radius)
                    enemies[i].Damage(this.damage/5, clients.filter(x => x.ship && x.ship.id == this.emitter)[0]);
...
Projectile.prototype.CalculateDirections = function (clients) {
