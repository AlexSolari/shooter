...
Rocket.prototype.FindTarget = function(clients) {
    var nearest = undefined;
    this.distance = Infinity;
    
    var enemies = clients.map(c => c.ship).filter(s => s && s.state != "dead" && s.id != this.emitter);
...
Rocket.prototype.CalculateDirections = function (clients) {
    if (this.lifeSpan-- < 0) {
...
RocketFactory.prototype.DetectStats = function (projectile) {
...
RocketFactory.prototype.CreateRocket = function (x,y, direction, emitter, type) {
