...
function RocketPool(quantity) {
    console.log("Created rocketPool");
...
RocketPool.prototype.projectiles = [];
...
RocketPool.prototype.ActivateProjectile = function(x, y, direction, emitter) {
    ...
    if (!wrapper)
    {
        var newProjectile = {
            isActive: true,
            entity: rocketFactory.CreateRocket(x, y, vectorFactory.CreateVector(0, 0, direction.x * spread(), direction.y * spread()), emitter, this.realtimeScaleCoefficient),
        };
    ...
    rocketFactory.DetectStats(projectile, this.realtimeScaleCoefficient);
...
RocketPool.prototype.UpdateActiveProjectiles = function (ships) {
